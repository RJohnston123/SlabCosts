...
namespace CMPS_285//.JobInfo.Options
{
    class ThickenedEdge : Options
    {
        ...
        public ThickenedEdge(/*TODO double databasePrices*/) //Driveway varName = new Driveway();
        {
            _name = Constants.o_thickenedEdge; //TODO, get name from the constants class.
