...
namespace CMPS_285
{
    class PoolDeck : Options
    {
        ...
        public PoolDeck(/*TODO double databasePrices*/) //Driveway varName = new Driveway();
        {
            _name = Constants.o_poolDeck; //TODO, get name from the constants class.
