...
namespace CMPS_285//.JobInfo.Options
{
    class BrickLedge : Options
    {
        ...
        public BrickLedge(/*TODO double databasePrices*/) //Driveway varName = new Driveway();
        {
            _name = Constants.o_brickLedge; //TODO, get name from the constants class.
